...
class RelayController:
    ...
    def on_energy_read(self, message):
        ...
        print("RECEIVED: Energy transmitted {}W".format(self.energy_transmitted))
    ...
    def send_order(self, relay_number=1, energy_to_buy=50):
        energy_master = NetServer(get_local_ip_address(), SERVER_PORT)
        energy_order_host = '10.64.194.14' 
...
def test_receive_order():
    print("TEST RECEIVE ORDER")
    rc = RelayController()
    rc.receive_order()


def test_send_order():
    print("TEST SEND ORDER")
    rc = RelayController()
    rc.send_order()
